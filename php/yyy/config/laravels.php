...
return [
    ...
    'swoole_tables'            => [
        'chatroom' => [
            'size' => 1024,
            'column' => [
                ['name' => 'id', 'type' => \Swoole\Table::TYPE_INT, 'size' => 8],
                ['name' => 'username', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 64],
                ['name' => 'message', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 512],
            ]
        ],
        'user' => [
            'size' => 10240,
            'column' => [
                ['name' => 'value', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 64],
            ]
        ]
