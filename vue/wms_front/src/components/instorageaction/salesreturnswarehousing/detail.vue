  ...
  <div class="grid-container">
    <div class="page-bread">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item
          :to="{ path: '/instorage_action/sales_returns_warehousing' }"
        >退货入库{{ show?'详情':'处理' }}</el-breadcrumb-item>
      ...
      <el-tabs activeName="table">
        <el-tab-pane label="商品明细" name="table">
          ...
          <el-table :data="showList" stripe style="width: 100%">
            ...
            <el-table-column prop="AdmQnty" label="受注确认数量" min-width="150"></el-table-column>
...
<script>
import { getById, stockIn, hasStocked } from "@/api/sales_return_instorage";
...
export default {
  ...
  created() {
    ...
    this.detailLabel = this.show ? "退货入库详情" : "退货入库处理";
