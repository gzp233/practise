  ...
  <div class="grid-container">
    <div class="page-bread">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/instorage_action/sales_returns_warehousing' }">退货入库确认</el-breadcrumb-item>
        <el-breadcrumb-item>确认</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="detail-content">
      <el-tabs activeName="detail">
        <el-tab-pane label="退货入库确认" name="detail">
          <el-row>
            <el-col :span="10">
...
<script>
import { getById, confirmRe, hasStocked } from "@/api/sales_return_instorage";
  ...
  methods: {
    ...
    childByValue: function(childValue) {
      ...
      for(let i=0;i<childValue.length;i++){
          childValue[i].conversion = this.order.OrderNo
      };
