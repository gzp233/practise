  ...
  <div class="grid-container">
    <div class="page-bread">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/instorage_action/inner_storage' }">内向交货入库确认</el-breadcrumb-item>
        <el-breadcrumb-item>确认</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="detail-content">
      <el-tabs activeName="detail">
        <el-tab-pane label="内向交货入库确认" name="detail">
          <el-row>
            <el-col :span="10">
      ...
      <el-tabs activeName="table">
        <el-tab-pane label="商品明细" name="table">
          ...
          <el-table :data="showList" stripe style="width: 100%">
            ...
            <el-table-column prop="InQnty" label="受注数量" min-width="150"></el-table-column>
    ...
    <reply
      :goodsData="{goodsList:goodsList02, params:{no_state_names:['C302', '加工完成'],state_names:['C101','C701']}}"
...
<script>
import { getById, confirmRe, hasStocked } from "@/api/inner_storage";
  ...
  methods: {
    ...
    childByValue: function(childValue) {
      ...
      for(let i=0;i<childValue.length;i++){
          childValue[i].conversion = this.order.CustomerOrderNo
      };
