  ...
  <div class="grid-container">
    <div class="page-bread">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item
          :to="{ path: '/instorage_action/movement_storage' }"
        >移动入库{{ show?'详情':'处理' }}</el-breadcrumb-item>
      ...
      <el-tabs activeName="table">
        <el-tab-pane label="商品明细" name="table">
          ...
          <el-table :data="showList" stripe style="width: 100%">
            ...
            <el-table-column prop="MovAdmQnty" label="受注确认数量" min-width="150"></el-table-column>
            <el-table-column prop="todoNumber" label="未入库" min-width="150"></el-table-column>
...
<script>
import { getById, stockIn, hasStocked } from "@/api/movement_storage";
...
export default {
  ...
  created() {
    ...
    this.detailLabel = this.show ? "移动入库详情" : "移动入库处理";
