	...
	<div class="grid-container">
		<div class="search-form">
			<el-form :inline="true" :model="query">
				<el-form-item label="退货原因">
					<el-input v-model="query.RejectedReasonNm" placeholder="退货原因"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<div class="grid-content">
			<el-table :data="tableData" v-loading.body="loading" stripe height="800" style="width: 100%">
				...
				<el-table-column prop="RejectedReasonCd" label="退货原因代码" min-width="200">
				</el-table-column>
				<el-table-column prop="RejectedReasonNm" label="退货原因名称" min-width="200">
				</el-table-column>
...
<script>
	...
	import { getIndex, del }from '@/api/rejected'
	export default {
		name: 'location',
		data: function() {
			return {
