	...
	<div class="grid-container">
		<div class="search-form">
			<el-form :inline="true" :model="query">
				<el-form-item label="产品系列名称">
					<el-input v-model="query.SERIESNM" placeholder="产品系列名称"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<div class="grid-content">
			<el-table :data="tableData" v-loading.body="loading" height="800" stripe style="width: 100%">
				...
				<el-table-column prop="SERIESCD" label="产品系列代码" min-width="200">
				</el-table-column>
				<el-table-column prop="SERIESNM" label="产品系列名称" min-width="200">
				</el-table-column>
...
<script>
	...
	import { getIndex, del }from '@/api/series'
	export default {
		name: 'location',
		data: function() {
			return {
