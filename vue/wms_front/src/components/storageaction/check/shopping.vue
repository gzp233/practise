...
<script>
    import { shoppingList, getGoodsByProductId, getByNo, relieve ,separate ,shopping,del} from "@/api/check";
    ...
    export default {
        ...
        methods: {
          getRowKeys(row){
            ...
            toShelf() {
                this.$router.push({
                    path: "/storage_action/check/detail/"+this.$route.params.id
                });
            },
            ...
            car(){
                this.$router.push({
                    path: "/storage_action/check/shopping/"
                });
                this.loadData(this.$route.params.id);
            },
            shopping(){
