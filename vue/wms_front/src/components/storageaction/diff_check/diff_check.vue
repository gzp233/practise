<template>
  <div class="grid-container">
    ...
    <div class="grid-page">
      ...
      <!-- dialog -->
      <el-dialog title="新建盘点" :visible.sync="dialogVisible" width="50%" :modal-append-to-body="false">
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="doCreates">确 定</el-button>
        </span>
      </el-dialog>
...
//        buttonDisabled:false,
    ...
    methods: {
      ...
      handleList() {
//        this.box_code = new Date().getTime()+Math.floor(Math.random()*100);
...
//      },
      ...
      showDetail: function(detail) {
        ...
        this.$router.push({
          path: "/storage_action/diff_check/detail/"+detail.code
        });
      },
    }
  };
