        ...
        <div class="grid-content">
            <el-table
                ...
                <el-table-column
                        ...
                        width="150"
                ></el-table-column>
                <el-table-column prop="number" label="异动次数" width="100"></el-table-column>
            </el-table>
        </div>
        <div class="grid-page">
            <el-pagination
...
<script>
    import { goodsList, getGoodsByProductId, getByNo, relieve ,getDetailById,shopping} from "@/api/diff_check";
    ...
    export default {
        ...
        methods: {
            ...
            car(){
                this.$router.push({
                    path: "/storage_action/diff_check/shopping/"+this.$route.params.id
                });
                this.loadData(this.$route.params.id);
            },
            batches() {
