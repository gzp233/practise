    ...
    <div class="grid-container">
        <div class="page-bread">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item :to="{ path: '/storage_action/diff_check/list/'+order.check_no }">异动盘点</el-breadcrumb-item>
                <el-breadcrumb-item>异动盘点详情</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <span style="margin-left:10px;">
                ...
                <el-table :data="postShowList" stripe style="width: 100%">
                    ...
                    >
                        <template slot-scope="scope">
                            <div class="table-form-item">
                                <el-select v-model="scope.row.act_state_name" placeholder="C101">
                                    <el-option
...
<script>
    import { getById, relieve ,unfreeze,unfreezeIndex,getAllProducts,getGoodsByProductId} from "@/api/diff_check";
...
//                act_state_name:"C101",
        ...
        methods: {
            ...
            rollback() {
                ...
                this.$router.push({
                    path: "/storage_action/diff_check/particulars/"+this.$route.params.id
                });
            });
            },
