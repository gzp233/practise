...
import { getToByStockNo, stockTo, getOriginGoodsList,getGoodsList } from "@/api/out";
...
export default {
  ...
  mounted() {    
    getGoodsList({"yiku_no":this.$route.query.moveNumber,"stock_no":this.$route.query.stock_no}).then(res =>{
       console.log(res)
