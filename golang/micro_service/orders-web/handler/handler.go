...
import (
	...
	auth "micro_service/auth/proto/auth"
	invS "micro_service/inventory-srv/proto/inventory"
	orders "micro_service/orders-srv/proto/orders"
...
func New(w http.ResponseWriter, r *http.Request) {
	...
	rsp, err := serviceClient.New(ctx, &orders.Request{
		BookId: bookId,
		UserId: session.GetSession(w, r).Values["userId"].(uint64),
	})
