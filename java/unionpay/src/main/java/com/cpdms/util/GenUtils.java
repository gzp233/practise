...
import com.cpdms.model.custom.ColumnEntity;
import com.cpdms.model.custom.GenVo;
import com.cpdms.model.custom.TableEntity;
import com.cpdms.model.custom.TsysTables;
...
*/
    ...
    public static void generatorCode(TsysTables table, List<Map<String, String>> columns, ZipOutputStream zip,GenVo genVo) {
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.cpdms" : mainPath;
        //封装模板数据
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
            	if(com.cpdms.util.StringUtils.isNotNull(genVo.getIsdown())) {
            		...
            		if(com.cpdms.util.StringUtils.isNotNull(filepath)) {
