...
import com.cpdms.mapper.auto.SysNoticeMapper;
import com.cpdms.mapper.auto.SysNoticeUserMapper;
import com.cpdms.model.auto.SysNotice;
import com.cpdms.model.auto.SysNoticeExample;
import com.cpdms.model.auto.SysNoticeUser;
import com.cpdms.model.auto.SysNoticeUserExample;
import com.cpdms.model.auto.TsysUser;
import com.cpdms.model.auto.TsysUserExample;
import com.cpdms.model.auto.SysNoticeUserExample.Criteria;
...
public class SysNoticeService implements BaseService<SysNotice, SysNoticeExample>{
	 ...
	 */
	 public PageInfo<SysNotice> list(TsysUser tsysUser,Tablepar tablepar,String name){
			...
			if(noticeUsers!=null&&noticeUsers.size()>0) {
		        ...
		        com.cpdms.model.auto.SysNoticeExample.Criteria criteria1= testExample.createCriteria();
		        if(name!=null&&!"".equals(name)){
	 ...
	 */
	public List<SysNotice> getuserNoticeNotRead(String userId,int state){
		List<SysNotice> notices=new ArrayList<SysNotice>();
		//查询未阅读的公告用户外键
		SysNoticeUserExample sysNoticeUserExample=new SysNoticeUserExample();
		Criteria criteria= sysNoticeUserExample.createCriteria();
		criteria.andUserIdEqualTo(userId/*tsysUser.getId()*/);
		if(-1!=state) {
