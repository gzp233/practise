package com.cpdms.common.quartz;
...
import com.cpdms.model.auto.SysQuartzJob;
import com.cpdms.model.auto.SysQuartzJobExample;
import com.cpdms.service.SysQuartzJobService;
...
public class CpdmsQuartzScheduler {
    ...
    public void start()
{
    ...
    public  void run(SysQuartzJob job) throws SchedulerException
    {
        ...
        quartzScheduler.triggerJob(getJobKey(job), dataMap);
    }
    /**
     * 暂停任务
     * @param job
    ...
    public void getquartzList() throws SchedulerException {
        ...
        for (String groupName : triggerGroupNames) {
        	...
        	//获取所有的triggerKey
        	 Set<TriggerKey> triggerKeySet = quartzScheduler.getTriggerKeys(groupMatcher);
        	 for (TriggerKey triggerKey : triggerKeySet) {
        		 //通过triggerKey在scheduler中获取trigger对象
                 CronTrigger trigger = (CronTrigger) quartzScheduler.getTrigger(triggerKey);
                 //获取trigger拥有的Job
                 JobKey jobKey =trigger.getJobKey();
                 JobDetailImpl jobDetail2 = (JobDetailImpl) quartzScheduler.getJobDetail(jobKey);
