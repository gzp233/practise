...
import com.cpdms.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils
{
    ...
    public static String getPersonnel_dir() {
        String url=ClassUtils.getDefaultClassLoader().getResource("").getPath()+V2Config.getPersonnel_dir();
        return url;
    }
